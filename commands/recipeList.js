  ...
  async getProfessionRecipes(sProfession, interaction) {
    ...
    return new Promise((resolve, reject) => {
      ...
      connection.connect((error) => {
        ...
        const query = `SELECT * FROM crafting_recipes WHERE recipe_profession = ? ORDER BY recipe_name ASC`;
  ...
  async getJcRecipesByColor(sColor, interaction) {
    ...
    return new Promise((resolve, reject) => {
      ...
      connection.connect((error) => {
        ...
        // Query the crafting_recipes table
        const query = `SELECT * FROM crafting_recipes WHERE jc_color = ? ORDER BY recipe_name ASC`;
